...
public class Curso {
    ...
    public void setProfesor(Profesor p){ // Asigna/cambia el profesor sincronizando ambos lados.
        ...
        if (this.profesor == p){
            System.out.println("Profesor ya asignado");
        }
        ...
        this.profesor = p; // Se asigna el parámetro
        if (p != null && !p.getCursos().contains(this)){ // Se agrega el profesor si cumple la condición
            p.agregarCurso(this);
        }
